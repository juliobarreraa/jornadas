 ...
 * @since       2.5
 */
class JornadasHelper
{
	/**
	 * @var		string	The extension name.
	 * @since	2.5
	 */
	public static $extension = 'com_jornadas';
	...
	public static function addSubmenu($vName)
	{
		JSubMenuHelper::addEntry(
			JText::_('COM_JORNADAS_SUBMENU_INDEX'),
			'index.php?option=com_jornadas&view=index',
			$vName == 'index'
		);
		JSubMenuHelper::addEntry(
			JText::_('COM_JORNADAS_SUBMENU_MAPS'),
