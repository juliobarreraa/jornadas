...
abstract class JHtmlJornadas
{
	...
	public static function typeslist()
	{
		...
		foreach ($rows as $row)
		{
			$key = $lang->hasKey($row->text);
			$string = JText::sprintf('COM_JORNADAS_ITEM_X_ONLY', JText::_($key));
	...
	public static function mapslist()
	{
		...
		// Compile the options.
		$options = array();
		$options[] = JHtml::_('select.option', '1', JText::_('COM_JORANADAS_BRANCHES'));
